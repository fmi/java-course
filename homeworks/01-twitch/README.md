...
`Content` е интерфейс, който представлява различното съдържани (`Stream` и `Video`) и има следния вид: 
```java
...
- Съдържанията, които има в платформата се представят чрез интерфейсите `Stream` и `Video`.
- Под `Contetnt` в платформата, разбираме видео или стрийм, който в момента е акитвен.
