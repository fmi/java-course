...
.center[![Where are we?](images/08.0-where-are-we.png)]
...
```java
Supplier<Integer> supplyYear = () -> 2025;
...
Останалите 39 функционални интерфейси в [`java.util.function`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/function/package-summary.html) са вариации на четирите разгледани.
...
Predicate<String> filter = "Коко"::equalsIgnoreCase;
```
...
- Интерфейсите и класовете от пакета [`java.util.stream`](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/stream/package-summary.html), които съвкупно наричаме Java Stream API, са предназначени за ефективната последователна или паралелна обработка на крайни или безкрайни потоци от данни
...
Операции, които могат да прекратят обхождането на потока преждевременно. Полезни са при безкрайни потоци.
...
- [Package java.util.stream](https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/util/stream/package-summary.html)
