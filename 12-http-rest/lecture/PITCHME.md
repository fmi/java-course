...
![HTTP request](images/12.1-http-request.png)
...
![HTTP sample request](images/12.2-http-sample-request.png)
...
![HTTP response](images/12.4-http-sample-response.png)
...
<small>
Понеже HTTP протоколът няма вградена поддръжка на сесии, ако има нужда сървърът да може да корелира заявките, идващи от един и същи клиент като логически принадлежащи към една последователност, обиkново се ползва един от следните начини:
...
![HTTP2 Multiplexing](images/12.6-http2-multiplexing.png)
...
- 43% от всички web sites към януари 2020 (33% през януари 2019)
