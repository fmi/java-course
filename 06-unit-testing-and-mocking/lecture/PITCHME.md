...
<small>*Chuck Norris doesn’t need unit tests because his code always works. ALWAYS.<p><p>
...
- Името на теста трябва да достатъчно ясно да описва сценария
...
<small>Друга конвенция е методите да се кръщават
...
givenNegativeNumbersWhenUserMultipliesThenResultShouldBePositive()
...
<small>
    <ul>
        <li>Ще разглеждаме mockito (3.1.0) като mocking библиотека</li>
