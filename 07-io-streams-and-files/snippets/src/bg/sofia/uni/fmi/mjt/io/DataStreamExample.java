...
public class DataStreamExample {
     ...
     * https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/DataOutputStream.html
     */
    private static void writeWithDataStream() {
        try (var dataOutputStream = new DataOutputStream(new FileOutputStream("test.dat"))) {
            ...
            dataOutputStream.writeUTF("Koko");
     ...
     * https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/io/DataInputStream.html
     */
