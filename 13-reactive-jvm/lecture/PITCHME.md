...
![JVM Architecture](images/13.2-jvm-overall-architecture.png)
...
<small>
- това е един от най-новите GC: наличен е като експериментален от JDK 11
...
- low-pause: може да събира неизползвана памет concurrently с работата на Java приложението
...
![Goodbye](images/13.21-goodbye.png)
