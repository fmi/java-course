...
- (+) Възможност за генерална оптимизации от библиотеката/компилатора/езика
...
- Функционалните езици третират функциите като първостепенни конструкции, т.е. може   правим всичко, което може да правим с обекти в ООП:
...
- С цел по-удобен дизайн на ламбда израза, може да се изпусне типа на променливите
