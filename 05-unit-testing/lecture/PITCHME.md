...
- [JUnit](https://github.com/junit-team/junit4) е най-популярният Java тестов framework
- Дефакто стандартния testing framework в Java
...
#### Защо ни трябват test frameworks?
...
- Добре написаните тестове не трябва да разчитат на конкретен ред
...
- Обикновено unit тестовете живеят в отделен проект или в отделна source директория, за да са отделени от продуктивния код
