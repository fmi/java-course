...
public class NonTrivialDeadLock {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread t1 = new Thread(() -> transferNaive(ivan, pesho, 100));

        Thread t2 = new Thread(() -> transferNaive(pesho, ivan, 100));
    ...
    // This will deadlock!
    public static void transferNaive(BankAccount source, BankAccount target, double amount) {
        synchronized (source) {
