...
public class HowManyVirtualThreadsDoingSomething {
    ...
    // Activate basic GC logging: -Xlog:gc

    // jmap -histo <pid>
    // Produces a class histogram (counts and total bytes per class) from the Java heap.
    // Light‑weight, quick, great for spotting which classes dominate heap usage.
