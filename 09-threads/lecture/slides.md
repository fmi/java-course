...
.center[![Multi-Core CPUs](images/09.3-multi-core-cpus.png)]
...
atomicInt.set(2022);
System.out.println(atomicInt.get()); // 2022
```
...
System.out.println(atomicInt.incrementAndGet()); // 2023

// thread-safe вариант на i += x (i=i+x)
System.out.println(atomicInt.addAndGet(5)); // 2028
