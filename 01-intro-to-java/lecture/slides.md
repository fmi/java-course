...
- Ако посочим големината на масива при инициализацията му и референцията не напуска обхвата на функцията, то JVM ще задели памет за обектите на масив в стека. За допълнителна информация [тук](https://en.wikipedia.org/wiki/Escape_analysis)
